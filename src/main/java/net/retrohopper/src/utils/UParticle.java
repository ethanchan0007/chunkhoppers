...
public enum UParticle {//
    ...
    */
    ...
    ;
    private static final HashMap<String, UParticle> inMemory = new HashMap<String, UParticle>();
    ...
    UParticle(String... names) {
        ...
        if (versionName != null)
            this.particle = v.contains("1.8") ? Effect.valueOf(versionName) : org.bukkit.Particle.valueOf(versionName);
    }
    ...
    public void play(Player player, Location l, int count) {
        if (v.contains("1.8")) {
            ...
            player.spawnParticle((org.bukkit.Particle) particle, l, count);
        }
    }
    ...
    public void play(Player player, Location l, int count, Material material) {
        if (v.contains("1.8")) {
            ...
            player.spawnParticle((org.bukkit.Particle) particle, l, count, material);
        }
    }
    ...
    public void play(Location l, int count) {
        ...
        if (v.contains("1.8")) {
            ...
            w.spawnParticle((org.bukkit.Particle) particle, l, count);
        }
    }
    ...
    public void play(Location l, int count, Material material) {
        ...
        if (v.contains("1.8")) {
            ...
            w.spawnParticle((org.bukkit.Particle) particle, l, count, material);
        }
    }
